...
import LeftArrow from "@/public/images/svg/leaderboard/left-arrow.svg";
import RightArrow from "@/public/images/svg/leaderboard/right-arrow.svg";
...
>(
  (
    { orientation = "horizontal", opts, setApi, onSettle, plugins, className, children, ...props },
    ref,
  ) => {
