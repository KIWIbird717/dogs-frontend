...
export const LinkButton: FC<LinkButtonProps> = ({ children, className, disabled, ...props }) => {
  return (
    <Link
      {...props}
      className={cn(
        "h-[48px] w-[48px] rounded-xl border border-black-400 bg-black-400 p-3 shadow-buttonNoAccent transition-all duration-75 active:translate-y-1 active:scale-95",
        disabled &&
